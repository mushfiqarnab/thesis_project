...
\end{itemize}
% TODO(authors): The markdown cites a "Bangladesh Personal Data Protection Act (PDPA)
% 2026". Verify the exact name, year, and status of the Bangladeshi data-protection
% instrument you intend to cite (for example, whether it is an enacted act or an
% ordinance), obtain an official source, and add a bibliography entry before including
% any claim about it. The markdown's GDPR table should not be reused: Article 22 is not
% a "right to explanation" and Article 15 is the right of access, not a transparency
