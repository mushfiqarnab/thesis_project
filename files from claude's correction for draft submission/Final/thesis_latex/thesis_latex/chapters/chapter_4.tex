...
This accuracy and CF gap were identical across all three regimes (biased, neutral, and inverted) in autonomous mode. The DP gap of 0.0040 and EO gap of 0.0346 specifically reflect its performance in the biased regime.
...
% Verified: The figure uses Line B FFHQ images. No pulse claims are made.
...
Measurements were taken with a batch size of 1 using 4 intra-op threads in ONNX Runtime, and exclude the latency of preprocessing (e.g., face cropping) as the test used a pre-allocated dummy tensor.
...
\begin{itemize}
    ...
    % No other EQUITAS-RCMF seeds have been evaluated.
\end{itemize}
