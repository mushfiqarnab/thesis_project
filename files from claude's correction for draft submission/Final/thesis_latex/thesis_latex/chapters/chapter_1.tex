...
\begin{enumerate}
    ...
    \item \textbf{Counterfactual evaluation of scar reliance.} An evaluation of the counterfactual gap, demographic parity, and equalized odds across demographic subgroups, together with a test protocol in which the scar is positively correlated, uncorrelated, or negatively correlated with the label.
